...
class VideolistViewController: UIViewController {
    ...
    func videoList(strpage: String) {
        ...
        wc.callSimplewebservice(url: videos, parameters: parem, headers: headers, fromView: self.view, isLoading: false) { (sucess, response: VideoListresponseModel?) in
            if sucess {
...
extension VideolistViewController: UITableViewDelegate,UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        let video = arrDocList[indexPath.row]
        ...
        cell.lblDiscription.text = video.datumDescription
        let strimage = video.image
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        obj.titlevideo = document.title
        obj.videoUrl = document.video_url
        obj.descripVideo = document.datumDescription
