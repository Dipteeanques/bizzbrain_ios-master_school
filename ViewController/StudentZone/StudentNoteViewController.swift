...
class StudentNoteViewController: UIViewController {
    ...
    func getNote() {
      ...
      let headers: HTTPHeaders = ["Xapi": Xapi,
                             "Authorization":token]
      AF.request(getNotestudent, method: .post, parameters: param, encoding: JSONEncoding.default,headers: headers)
...
extension StudentNoteViewController: UITableViewDelegate,UITableViewDataSource {
    func tableView(_ tableView: UITableView, numberOfRowsInSection section: Int) -> Int {
        return arrResults.count
    }
    
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = tblView.dequeueReusableCell(withIdentifier: "cell", for: indexPath)as! tblstudentNoteCell
...
class tblstudentNoteCell: UITableViewCell {
