...
class DateSheetViewController: UIViewController {
    ...
    func examResultAPI() {
        ...
        let headers: HTTPHeaders = ["Xapi": Xapi,
                                    "Authorization":token]
        AF.request(upcoming_exam, method: .post, parameters: parameters, encoding: JSONEncoding.default,headers: headers)
...
extension DateSheetViewController: UITableViewDelegate,UITableViewDataSource {
...
//        cell.lblDate.text = result
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        let obj = self.storyboard?.instantiateViewController(withIdentifier: "SecondaryExamDetailsViewController")as! SecondaryExamDetailsViewController
        obj.arrFilterSearchDatum = arrFilterSearchDatum
        obj.exam_id = String(id!)
        self.navigationController?.pushViewController(obj, animated: true)
    }
...
class tblDatesheetCell: UITableViewCell {
