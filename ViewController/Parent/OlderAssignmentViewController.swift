...
class OlderAssignmentViewController: UIViewController {
    ...
    func getAssignment() {
        ...
        wc.callSimplewebservice(url: OLDERASSIGNMENT, parameters: param, headers: headers, fromView: self.view, isLoading: true) { (success, response: AssignmentResponsModel?) in
            if success {
...
extension OlderAssignmentViewController: UITableViewDelegate,UITableViewDataSource {
