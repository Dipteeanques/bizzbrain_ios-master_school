...
final internal class SampleData {
    ...
    let messageImages: [UIImage] = [#imageLiteral(resourceName: "attendances"), #imageLiteral(resourceName: "student_info")]
...
//    }
    ...
    func randomMessage(allowedSenders: [MockUser]) -> MockMessage {
        ...
        case .Url:
            return MockMessage(text: "123-456-7890", user: user, messageId: uniqueID, date: date)//MockMessage(linkItem: linkItem(), user: user, messageId: uniqueID, date: date)
        case .Phone:
    ...
    func getAvatarFor(sender: SenderType) -> Avatar {
        ...
        case "000001":
            return Avatar(image: #imageLiteral(resourceName: "account"), initials: initials)
        case "000002":
