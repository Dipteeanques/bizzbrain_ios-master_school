...
final internal class SampleData {
    ...
    let currentUser = MockUser(senderId: (loggdenUser.value(forKey:SENDER_ID) as! String), displayName: "")
    let recieverUser = MockUser(senderId: (loggdenUser.value(forKey:RECIEVER_ID) as! String), displayName: "")

    lazy var senders = [currentUser, recieverUser]//[nathan, steven, wu]
    ...
    let messageImages: [UIImage] = [#imageLiteral(resourceName: "icons8-new-post-100"), #imageLiteral(resourceName: "Home")]
...
//            guard UserDefaults.standard.bool(forKey: "\($0.rawValue)" + " Messages") else { return SampleData.MessageTypes(rawValue: "") }
//            return $0
//        }.random()!
//    }
...
//            messages.append(message)
    ...
    func getAvatarFor(sender: SenderType) -> Avatar {
        ...
        case "000001":
            return Avatar(image: #imageLiteral(resourceName: "ProfileMenu"), initials: initials)
        case "000002":
            return Avatar(image: #imageLiteral(resourceName: "ProfileMenu"), initials: initials)
        case "000003":
            return Avatar(image: #imageLiteral(resourceName: "ProfileMenu"), initials: initials)
